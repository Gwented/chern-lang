...
mod tests {
    ...
    fn mock_single_module_compiler(
        ...
        let compiler = ScriptCompiler::new(None, vec![module]);
    ...
    fn mock_multiple_module_compiler(
        ...
        let compiler = ScriptCompiler::new(None, modules);
    ...
    fn module_simple_test() {
        ...
        let mut compiler = ScriptCompiler::new(None, vec![main_mod, sub_mod]);
